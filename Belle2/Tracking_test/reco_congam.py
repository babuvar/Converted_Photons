...
#var_dict = json.load(open("variables_congam_vtx_only.json"))
...
#ma.fillParticleList("e+:loose", cut="", path=reco_path)


#ma.reconstructDecay('gamma:conv -> e+:loose e-:loose', cuts1, path=reco_path)
#ma.reconstructDecay('gamma:conv -> e+:loose e-:loose', cut="", path=reco_path)
