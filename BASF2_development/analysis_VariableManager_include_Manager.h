...
namespace Belle2 {
  ...
  namespace Variable {
    ...
    public:
      ...
      /** functions stored take a const Particle*, const std::vector<std::string>& and return double. */
      typedef std::function<double(const Particle*, const std::vector<std::string>&)> StringParameterFunctionPtr;
      ...
      /** A variable taking additional string arguments to influence the behaviour. */
      struct StringParameterVar : public VarBase {
        StringParameterFunctionPtr function; /**< Pointer to function. */
        /** ctor */
        StringParameterVar(const std::string& n, StringParameterFunctionPtr f, const std::string& d, const std::string& g = "")
          : VarBase(n, d, g), function(f) { }
      };
      ...
      /** Register a variable that takes string arguments (see Variable::Manager::StringParameterFunctionPtr). */
      void registerVariable(const std::string& name, const Manager::StringParameterFunctionPtr& f, const std::string& description);
    ...
    private:
      ...
      /** Creates and registers a concrete variable (Var) from a MetaVar, ParameterVar, stringParameterVar or numeric constant. */
      ...
      /** List of registered string parameter variables. */
      std::map<std::string, std::shared_ptr<StringParameterVar>> m_string_parameter_variables;
    ...
    public:
      ...
      /** constructor. */
      Proxy(const std::string& name, Manager::StringParameterFunctionPtr f, const std::string& description)
      {
        Manager::Instance().registerVariable(name, f, description);
      }
      /** constructor. */
